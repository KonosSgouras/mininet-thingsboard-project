...
def myNetwork():
    ...
    ap1 = net.addAccessPoint('ap1', cls=OVSKernelAP, ssid='ap1-ssid',
                             channel='1', mode='g', ip='10.0.0.50', position='224.0,416.0,0', range=200)
    ap2 = net.addAccessPoint('ap2', cls=OVSKernelAP, ssid='ap2-ssid',
                             channel='1', mode='g', ip='10.0.0.51', position='469.0,306.0,0', range=200)
    ...
    sta1 = net.addStation('sta1', ip='10.0.0.1',
                           position='118.0,462.0,0', range=50)
    ...
    ap1.cmd('ifconfig ap1 10.0.0.50')
