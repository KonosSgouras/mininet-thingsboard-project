...
def myNetwork():
    ...
    ap3 = net.addAccessPoint('ap3', cls=OVSKernelAP, ssid='ap3-ssid',
                             channel='1', mode='g', ip='10.0.0.95', position='727.0,553.0,0', range=300)
    ...
    ap5 = net.addAccessPoint('ap5', cls=OVSKernelAP, ssid='ap5-ssid',
                             channel='1', mode='g', ip='10.0.0.97', position='507.0,895.0,0', range=300)
    ...
    ap5.cmd('ifconfig ap5 10.0.0.97')
